        ...
        this.ws.onclose = async (event) => {
            ...
            if (event.code === 1006) {
                ...
                if (status.status === 401)
                    this._handlersEmit("connect_unauthorized", this.ws, status.msg);
                else if (status.status === 403)
                    this._handlersEmit("connect_forbidden", this.ws, status.msg);
                else if (status.status === 500)
                    this._handlersEmit("connect_serverError", this.ws, status.msg);
                return;
            }
